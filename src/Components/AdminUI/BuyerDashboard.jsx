  ...
  return (
    ...
    <Box sx ={{position: 'relative', top: 0,display: 'flex',zIndex: 2,flexDirection: 'column'}}>
     ...
     <Box sx={{display: 'flex', flexDirection: 'row',  justifyContent: 'center',flexWrap: 'wrap'}}>
          <Card sx={CardStyle}>
                <Typography variant='h4' sx={{fontWeight: 'bold'}}>Accredited Buyers</Typography>
                  <br></br>
                <Typography variant='h3' sx={{fontWeight: 'bolder', color: '#0C7230'}}><Number n={accreditedCount}/> </Typography>
          </Card>

          <Card sx={CardStyle}>
                <Typography variant='h4' sx={{fontWeight: 'bold'}}>Non-Accredited Buyers</Typography>
                  <br></br>
                <Typography variant='h3' sx={{fontWeight: 'bolder', color: '#0C7230'}}><Number n={nonAccreditedCount}/> </Typography>
          </Card>

          <Card sx={CardStyle}>
                <Typography variant='h4' sx={{fontWeight: 'bold'}}>For Checking Buyers</Typography>
                  <br></br>
