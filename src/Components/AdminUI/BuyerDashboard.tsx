  ...
  return (
    <Box sx ={{position: 'relative', top: 80,display: 'flex', flexDirection: 'column'}}>
        ...
        <Table sx={{ minWidth: innerWidth-333 }} aria-label="customized table">
            <TableHead>
                <Typography variant='h4' sx={{fontWeight: 'bold', padding: '20px 0px 20px  1px', color: 'green'}}>Buyer Verification</Typography>
            <TableRow>
    ...
    <Table sx={{ minWidth: innerWidth-333 }} aria-label="customized table">
    <TableHead>
        <Typography variant='h4' sx={{fontWeight: 'bold', padding: '20px 0px 20px  1px', color: 'green'}}>Buyer Profile</Typography>
        <TableRow>
        <StyledTableCell>First Name </StyledTableCell>
        <StyledTableCell align="center">Last Name</StyledTableCell>
