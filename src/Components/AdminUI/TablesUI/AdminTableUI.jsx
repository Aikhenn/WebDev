...
import EditDialog from "./AdminDialog/EditDialog";
import AddDialog from "./AdminDialog/AddDialog";
          ...
          <Tooltip title="Add new Data">
            <Button
              ...
              sx={{
                ...
                "&:hover": { backgroundColor: "#0C7230" },
              }}
              onClick={onAddClick}
            >
              <AddIcon sx={{ paddingRight: 0.6 }} /> Add Admin
            </Button>
          </Tooltip>
